...
const Dashboard = () => {
  ...
  const expiredPlanKey =
    (latestAccessCode?.plan as PlanKey | undefined) ||
    (subscription?.plan !== "trial" ? (subscription?.plan as PlanKey | undefined) : undefined);
  const expiredPlanName =
    expiredPlanKey && expiredPlanKey in PLANS ? PLANS[expiredPlanKey].name : "Paid plan";
                              ...
                              >
                                ...
                                {isCurrent ? (
                                  ...
                                  <span className="flex min-w-0 flex-col items-start gap-0.5 text-left leading-snug">
                                    ...
                                    <span className="text-[11px] font-normal opacity-90">Auto-renews monthly</span>
                                  </span>
                                )}
                              </Button>
                            )}
                            ...
                            >
                              ...
                              {isCurrent ? (
                                ...
                                <span className="flex min-w-0 flex-col items-start gap-0.5 text-left leading-snug">
                                  ...
                                  <span className="text-[11px] font-normal opacity-90">30-day access</span>
                                </span>
                              )}
                            </Button>
                          </div>
