  ...
  const handleSavePayment = async (provider: string) => {
    ...
    try {
      if (provider === "stripe") {
        ...
        await saveSetting("paystack_charge_currency", paystackChargeCurrency, false);
      }
      toast.success(
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Button
                        type="button"
                        size="sm"
                        variant={paystackChargeCurrency === "KES" ? "default" : "outline"}
                        onClick={() => setPaystackChargeCurrency("KES")}
                      >
                        KES
                      </Button>
                      <Button
                        type="button"
                        size="sm"
                        variant={paystackChargeCurrency === "USD" ? "default" : "outline"}
                        onClick={() => setPaystackChargeCurrency("USD")}
                      >
                        USD
                      </Button>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Controls Paystack checkout charge currency (default KES for backward compatibility).
                    </p>
                  </div>
                  <div className="space-y-2">
                    <Label>Secret Key</Label>
